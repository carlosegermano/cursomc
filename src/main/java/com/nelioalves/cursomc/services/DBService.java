...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Produto p9 = new Produto(null, "Agajour", 100.00);
		...
		cli1.getTelefones().addAll(Arrays.asList("27363323", "938383923"));
		
		Cliente cli2 = new Cliente(null, "Carlos Eduardo", "carlosegermano@gmail.com", 
				"24546875347", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("32214542", "986595622"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "544245785", cli2, c2);
